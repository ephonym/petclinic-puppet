class petclinic {
  ...
  $packages = ['openjdk-7-jre', 'tomcat7']
  ...
  exec { 'download-petclinic-war':
    command => '/usr/bin/curl -o petclinic.war http://172.28.128.3:8081/artifactory/libs-snapshot-local/org/springframework/samples/spring-petclinic/1.0.1-SNAPSHOT/spring-petclinic-1.0.1-20190427.001812-1.war',
